...
app.get('/health', (_req, res) => res.json({ok:true,app:'Core Ops Workflow Web',version:WEB_VERSION,webVersion:WEB_VERSION,apiVersion:API_VERSION,apiProxy:apiUrl.origin,licensing:'activation-and-sync',brand:'core-ops-workflow',topNavigation:'compact-primary',enterpriseModules:'complete',reporting:'executive-and-operational',dcamBridge:'shared-users-workflow-handoffs',monitoring:'http-tcp-foundation',sla:'policy-tracking',notifications:'in-app-alert-centre',hardening:'production-readiness',i18n:['en-GB','ro-RO']}));
