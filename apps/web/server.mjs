...
app.get('/health', (_req, res) => res.json({ ok:true, app:'Core Ops Workflow Web', version:'v22', apiProxy:apiUrl.origin, equipment:'half-u-depth-aware', licensing:'activation-and-sync', brand:'core-ops-workflow', loginRender:'static-css-atomic', enterpriseModules:'complete', reporting:'live-summary', dcamBridge:'live-overview-login-safe', i18n:['en-GB','ro-RO'] }));
...
app.listen(port,'0.0.0.0',()=>console.log(`Core Ops Workflow Web v22 listening on ${port}; API proxy ${apiUrl.origin}; atomic branded login; DCAM live overview; languages en-GB, ro-RO`));
