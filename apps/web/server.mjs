...
app.get('/health', (_req, res) => res.json({ok:true,app:'Core Ops Workflow Web',version:'v27',apiProxy:apiUrl.origin,equipment:'half-u-depth-aware',licensing:'activation-and-sync',brand:'core-ops-workflow',loginRender:'static-css-atomic',topNavigation:'full-static-menu',enterpriseModules:'complete',reporting:'live-summary',dcamBridge:'live-overview-identity-mapping-record-drill-in',monitoring:'http-tcp-foundation',sla:'policy-tracking-foundation',versionDisplay:'current-build',i18n:['en-GB','ro-RO']}));
...
app.listen(port,'0.0.0.0',()=>console.log(`Core Ops Workflow Web v27 listening on ${port}; API proxy ${apiUrl.origin}; SLA management; Monitoring foundation; full static top menu; languages en-GB, ro-RO`));
